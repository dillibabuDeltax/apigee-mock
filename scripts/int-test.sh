...
./node_modules/.bin/cucumber-js --world-parameters '{"stack":"apis","datapath":"data","dataenv":"","protocol":"https","host":"'"${apigeeNorthBoundDomain}"'","report_name":"apigee-mock","mockFlag":true}' ./test/integration-v2/both-features/* ./test/integration-v2/solo-features/mock-only.feature ./test/integration-v2/framework_step_definitions/report.feature -f json:reports/cucumber_report.json
fi
...
./node_modules/.bin/cucumber-js --world-parameters '{"stack":"apis","datapath":"data","dataenv":"","protocol":"https","host":"'"${apigeeNorthBoundDomain}"'","report_name":"apigee-mock","mockFlag":false}' ./test/integration-v2/both-features/* ./test/integration-v2/solo-features/dbpl-only.feature ./test/integration-v2/framework_step_definitions/report.feature -f json:reports/cucumber_report.json
fi
